def calculate_marker_specificity_sensitivity(
    ...
    """Quantifying False Positive Rate/Specificity/etc.

    Calculates the ratio of the expression level of the marker in the cluster of interest to its expression in other clusters.
    """
