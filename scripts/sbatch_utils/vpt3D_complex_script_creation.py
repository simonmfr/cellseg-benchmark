...
JOB_REPO_PATH = "$HOME/gitrepos/cellseg-benchmark"
SBATCH_DIR = BASE_PATH / "misc/sbatches/sbatch_vpt_3D_complex"

with open(BASE_PATH / "misc/sample_metadata.yaml") as f:
    data = yaml.safe_load(f)

EXPERIMENT_JSON_PATH = f"{JOB_REPO_PATH}/configs/vpt_3D_{args.staining1}_{args.staining2}.json"
RUN_LOG_PATH = f"{JOB_REPO_PATH}/scripts/sbatch_utils/run_log.sh"
...
cp "{JOB_REPO_PATH}/scripts/segmentation/vpt_plugin_cellpose_predict.py" "${{PKG}}/predict.py"
