...
parser.add_argument(
    ...
    nargs="?",
    default="total_mrna",
    help="Cytoplasm staining (e.g. total_mrna, PolyT). Defaults to total_mrna, which is generated by sis.SpotTable.load_merscope.",
)
args = parser.parse_args()

SBATCH_DIR = Path(f"{cb.BASE_PATH}/misc/sbatches/sbatch_SIS")
