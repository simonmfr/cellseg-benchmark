...
from cellseg_benchmark.sdata_utils import calculate_volume
...
parser = argparse.ArgumentParser(
    description="TMP fix Merlin merging."
)
parser.add_argument("cohort", help="Cohort name, e.g., 'foxf2'")
parser.add_argument(
    "seg_method", choices=["Cellpose_1_Merlin"], help="Segmentation method, e.g., 'Cellpose_1_nuclei_model'"
)
parser.add_argument(
    "--age",
    default=False,
...
for sample_dir in samples_path.glob(f"{args.cohort}*"):  # restriction to cohort folders
    ...
    sdata = read_zarr(sample_dir / "sdata_z3.zarr", selection=("tables","shapes"))
