...
if __name__ == "__main__":
    ...
    adatas = [
        ("foxf2_s1_r0", read_h5ad("/Users/jonasflor/Downloads/foxf2_s1_r0.h5ad")),
        ("foxf2_s1_r1", read_h5ad("/Users/jonasflor/Downloads/foxf2_s1_r1.h5ad")),
    ]
    adata = adatas[0][1]
    obs = pd.read_csv("/Users/jonasflor/Downloads/adata_obs_annotated_1_0.csv")[
        [
    ...
    new_obs = adata.obs.merge(obs, how="left", left_index=True, right_on="cell_id")
    ...
    tmp = merge_adatas_deb(
        adatas,
        logger=logger,
        do_qc=False,
        save_path="/Users/jonasflor/Desktop/debug_pics",
    )
    tmp = filter_cells(
        tmp, save_path="/Users/jonasflor/Desktop/debug_pics", logger=logger
    )
    tmp = filter_genes(
        tmp, save_path="/Users/jonasflor/Desktop/debug_pics", logger=logger
    )
    ...
    tmp = integration_harmony(
        tmp, "full_name", "/Users/jonasflor/Desktop/debug_pics", logger=logger
    )
