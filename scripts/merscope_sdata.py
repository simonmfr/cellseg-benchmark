...
sdata = merscope(data_path,
                 vpt_outputs={'cell_by_gene': join(data_path, 'cell_by_gene.csv'),
                              'cell_metadata': join(data_path, 'cell_metadata.csv'),
                              'cell_boundaries': join(data_path, 'cell_boundaries.parquet')}
                 )
