...
Path(f"/dss/dssfs03/pn52re/pn52re-dss-0001/cellseg-benchmark/misc/sbatch_nuclei_model").mkdir(parents=False, exist_ok=True)
for key, value in data.items():
    f = open(f"/dss/dssfs03/pn52re/pn52re-dss-0001/cellseg-benchmark/misc/sbatch_nuclei_model/{key}.sbatch", "w")
    f.write(f"""#!/bin/bash
...
python /dss/dssfs03/pn52re/pn52re-dss-0001/cellseg-benchmark/misc/sopa_api/api_nuclei.py {value} /dss/dssfs03/pn52re/pn52re-dss-0001/cellseg-benchmark/samples/{key}/results/Cellpose_1_nuclei_model
            """)
    f.close()
